...
- Name: storefront-product-cart.spec.js >> storefront context permutation tests >> Storefront Matrix: context-product-page-mobile - Product page on mobile viewport
