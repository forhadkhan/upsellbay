...
- Name: accessibility.spec.js >> accessibility smoke >> admin editor has keyboard focus targets and no serious axe violations
- Location: tests/e2e/accessibility.spec.js:18:2
