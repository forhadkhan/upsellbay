...
- Name: admin-offer-editor.spec.js >> admin offer editor permutation tests >> Offer Matrix: tier1-baseline-active - Baseline active product page offer with simple in-stock product
