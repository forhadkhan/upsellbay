...
Full task details in each phase file. Update status by changing the `<!-- STATUS: -->` comment at the top of each file. After completing each phase, commit the changes.
