...
The PRD, task files, and architecture notes define the shipped baseline. Because the PRD and planned phase tasks have already been fulfilled, current work may also be driven by direct reviews, QA findings, marketplace-readiness gaps, and user-approved improvement requests.

Use this priority order for new work:

1. Direct user instructions and review findings for the current improvement
2. Existing implementation (use graphify)

For historial context:
- `.meta/PRDs/UpsellBay-PRD-v4.md`
- `.meta/tasks/`
- `.meta/notes/plugin-development-blueprint.md`
- `.meta/notes/folder-structure-plan.md`

If improvement work changes, narrows, or intentionally deviates from PRD v4 or completed task expectations, document the reason in `.meta/architecture/` before continuing and call it out in your handoff. Do not re-open completed phase tasks unless the user explicitly asks for phase-status work.
