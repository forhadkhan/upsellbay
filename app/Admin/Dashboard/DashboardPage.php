...
final class DashboardPage {
	...
	public function render( array $request = array() ): void {
		...
		if ( 0 === (int) $data['active_offers'] ) {
			echo '<div class="upsellbay-onboarding-panel" style="background: #fff; border: 1px solid #c3c4c7; padding: 30px; text-align: center; margin-bottom: 24px; border-radius: 4px;">';
