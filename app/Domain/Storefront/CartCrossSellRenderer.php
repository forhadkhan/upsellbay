...
final class CartCrossSellRenderer extends AbstractOfferRenderer {
	...
	public function render_offer( array $offer, array $context = array() ): string {
		...
		$html .= '<div class="' . $this->esc_attr( implode( ' ', $classes ) ) . '" data-upsellbay-placement="cart_crosssell" data-upsellbay-offer-id="' . $this->esc_attr( (string) $offer_id ) . '"' . $source_order_attr . $viewed_product_attr . '>'
			. $image_html
