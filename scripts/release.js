/*
 * Release packager for UpsellBay.
 *
 * Creates:
 * - dist/upsellbay/  (staging folder)
 * - upsellbay.zip    (or upsellbay-<version>.zip with --versioned)
 */
...
(async () => {
	try {
		console.log('🚀 Starting UpsellBay release build...');
		...
		await copy_if_exists(path.join(ROOT_DIR, 'upsellbay.php'), path.join(STAGE_DIR, 'upsellbay.php'));
