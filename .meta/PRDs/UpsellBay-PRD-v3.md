...
| Version | 3.0, supersedes UpsellBay PRD v1.0 and v2.0 |
...
- Preserve the strategic boundary: no checkout replacement, no page-builder dependency, no gateway-tokenized one-click upsell in v1.
...
| WooCommerce platform baseline moved forward | WooCommerce 10.8 was released May 26, 2026, is ready for WordPress 7.0 styling, and requires WordPress 6.9+. Source: [WooCommerce 10.8 release notes](https://developer.woocommerce.com/2026/05/26/woocommerce-10-8-0-release/). WordPress 7.0 was released May 20, 2026. Source: [WordPress 7.0 documentation](https://wordpress.org/documentation/wordpress-version/version-7-0/). | v3 should target WooCommerce 10.8.x, WordPress 6.9+ minimum, WordPress 7.0 readiness, and native admin styling. |
...
### 3.2 What Merchants Are Actively Paying For
...
### 3.3 Market Gaps and Product Opportunities
...
### 5.1 Direct and Adjacent Competitors
...
### 6.6 Unique Selling Proposition
...
### 7.3 Customer Journey Alignment
...
### 8.7 Shopper Experience Requirements
...
## 9. Technical Product Requirements
...
### 9.2 WooCommerce Marketplace Standards
...
### 9.3 Admin Information Architecture
...
#### 9.4.3 Analytics aggregate table
...
### 9.6 Checkout and Block Integration
...
### 11.2 What Makes It Meaningfully Better
...
### 11.3 Reasons a Merchant Chooses UpsellBay Over Alternatives
...
### 12.1 Phase 0: Validation and Architecture Proof, Week 1
...
### 12.3 Phase 2: Core Checkout Bumps, Weeks 3-5
...
### 12.4 Phase 3: Product, Cart, and Thank-You Offers, Weeks 5-7
...
### 12.5 Phase 4: Analytics, Tools, and Polish, Weeks 7-9
...
### 12.6 Phase 5: Marketplace Readiness, Weeks 9-10
...
| Performance | Meets checkout and analytics budgets in Section 9.10. |
...
UpsellBay v1 should ship as a premium, Woo-native AOV engine that helps merchants add relevant offers across the product, cart, checkout, and thank-you journey while preserving the checkout they already trust. The product is commercially realistic at $79/year because the market already pays for order bumps, upsells, checkout optimization, and recovery tools. Its defensible differentiation is not having the longest feature list; it is having the safest, most native, most measurable implementation for merchants who want higher order value without funnel-builder lock-in.
