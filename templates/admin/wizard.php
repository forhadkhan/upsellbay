			...
			<tbody>
				<tr>
					...
					<td>
						...
						<?php echo function_exists( 'wc_help_tip' ) ? wp_kses_post( wc_help_tip( __( 'Choose the product shoppers can add from the first offer.', 'upsellbay' ) ) ) : ''; ?>
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="upsellbay-wizard-placement"><?php esc_html_e( 'Placement', 'upsellbay' ); ?></label></th>
					<td>
				...
				<tr>
					<th scope="row"><label for="upsellbay-wizard-headline"><?php esc_html_e( 'Headline', 'upsellbay' ); ?></label></th>
					<td><input id="upsellbay-wizard-headline" name="headline" type="text" class="regular-text"></td>
				</tr>
				<tr>
					<th scope="row"><?php esc_html_e( 'Preview first', 'upsellbay' ); ?></th>
					<td>
						<label>
